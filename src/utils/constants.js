...
export const BEGIN_THUMBS_UP = 'BEGIN_THUMBS_UP';
export const SUCCESS_THUMBS_UP = 'SUCCESS_THUMBS_UP';
export const FAIL_THUMBS_UP = 'FAIL_THUMBS_UP';
export const BEGIN_THUMBS_DOWN = 'BEGIN_THUMBS_DOWN';
export const SUCCESS_THUMBS_DOWN = 'SUCCESS_THUMBS_DOWN';
export const FAIL_THUMBS_DOWN = 'FAIL_THUMBS_DOWN';
